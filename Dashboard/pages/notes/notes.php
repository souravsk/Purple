...
<?php
function x($file_uploader)
{
 $mysqli=new mysqli('localhost','root','','notes') or die(mysqli_error($mysqli));
 $result = $mysqli->query("SELECT course FROM users WHERE username = '$file_uploader' ")or die($mysqli->error);
          ...
          <li class="nav-item nav-profile">
            <a href="#" class="nav-link">
              <div class="nav-profile-image">
                <img src="../../../UDashboard/profilepics/<?php echo $profilepic; ?>" size=300x500 alt="Profile">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="../../pages/Profile/profile.php?name=<?php echo $file_uploader; ?>"
                            style="color:black;  text-decoration:none;">
                            <?php echo ucfirst($file_uploader); ?></a>
                          <?php  
                                 $dept=x($file_uploader);
                          ?>
                          </td>
                          <td>
                            <?php
                          ...
                          <td>
                            ...
                            onclick="window.location.href='../../../UDashboard/allfiles/<?php echo $file; ?>'">
                             <i class="mdi mdi-cloud-download mdi-24px"></i>
                           </button>
                          </td>
                          <td><a onClick="javascript: return confirm('Are you sure to Approve <?php echo $file; ?> ?')" href='?approve=<?php echo $file_id; ?>'>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="../../pages/Profile/profile.php?name=<?php echo $file_uploader; ?>"
                            style="color:black;  text-decoration:none;">
                            <?php echo ucfirst($file_uploader); ?></a>
                          </td>
                          <td>
...
?>
<?php    
             function mailing($dept)
             {                       //Connect to database
                                    $mysqli=new mysqli('localhost','root','','notes') or die(mysqli_error($mysqli));
                                    $result = $mysqli->query("SELECT email FROM users WHERE course = '$dept' ")or die($mysqli->error); 
                                    ...
                                    $y=0;
                                     ...
                                     $list=array();
                                      array($list);
                                          while($y < $num){
                                             $list[$y]=mysqli_result($result,$y,'email');
                                             $y++;
                                          }
                                        ...
                                        try {                                       
                                            ...
                                            $mail->SMTPAuth   = true;                              
                                            $mail->Username   = 'ankitasingh3306@gmail.com';                  
                                            $mail->Password   = 'iambacksinu';                         
                                            $mail->SMTPSecure = 'tls';                               
                                            $mail->Port       = 587; 
                                               
                                          
                                            $mail->setFrom('ankitasingh3306@gmail.com', 'Purple Notes');             
                                            $mail->addAddress('sonupalak47@gmail.com', 'Purple Notes'); 
                                          ...
                                          $message = file_get_contents('../email/temp.html');
                                          $message = str_replace('tony', $bodyContent, $message);
                                          $mail->Subject = 'New Notes Uploaded';
                                          $mail->Body    = $message;
